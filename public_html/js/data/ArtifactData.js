...
TT2.Artifacts = [
    // S
    // 20.49 effect x
    {tier: 'S', id: 1, name: 'Book of Shadows', maxLvl: 0, addupPerLvl: 0.0541388888888889, damPerLvl: 0.3, costCoef: 0.7, costExp: 2.5, offset: 1, effect: 'Prestige Relic', pref: '&#10005', app: ''},
    // A
    ...
    {tier: 'A', id: 43, name: 'Invader\'s Gjalarhorn', maxLvl: 0, addupPerLvl: 0.02, damPerLvl: 0.2, costCoef: '1.2', costExp: 1.5, offset: 1, effect: 'All Active Skill Effect', pref: '&#10005', app: ''},
    // 199.2 effect x
    {tier: 'A', id: 4, name: 'Heroic Shield', maxLvl: 0, addupPerLvl: 0.2477, damPerLvl: 0.5, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Boss Gold', pref: '&#10005', app: ''},
    ...
    {tier: 'B', id: 17, name: 'Royal Toxin', maxLvl: 0, addupPerLvl: 0.1, damPerLvl: 0.5, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Deadly Strike Effect', pref: '&#10005', app: ''},
    {tier: 'B', id: 49, name: 'Heart of Storms', maxLvl: 0, addupPerLvl: 0.025, damPerLvl: 0.3, costCoef: 0.6, costExp: 1.7, offset: 1, effect: 'Splash Damage', pref: '+', app: '%'},
    {tier: 'B', id: 50, name: 'Coins of Ebizu', maxLvl: 0, addupPerLvl: 0.025, damPerLvl: 0.3, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Splash Gold', pref: '+', app: '%'},
    // 65.8 effect
    ...
    {tier: 'D', id: 42, name: 'X', maxLvl: 30, addupPerLvl: 1, damPerLvl: 0.8, costCoef: 0.7, costExp: 1.8, offset: 0, effect: 'All Active Skill Duration', pref: '+', app: 's'},
    // 26.46 effect
    ...
    {tier: 'D', id: 21, name: 'Titan Spear', maxLvl: 40, addupPerLvl: 1, damPerLvl: 0.8, costCoef: 0.6, costExp: 3, offset: 0, effect: 'Hand of Midas Mana Cost', pref: '-', app: 'm'},
    {tier: 'D', id: 22, name: 'The Arcana Cloak', maxLvl: 40, addupPerLvl: 1, damPerLvl: 0.8, costCoef: 0.6, costExp: 3, offset: 0, effect: 'War Cry Skill Mana Cost', pref: '-', app: 'm'},
    {tier: 'D', id: 41, name: 'Ambrosia Elixir', maxLvl: 40, addupPerLvl: 2, damPerLvl: 0.8, costCoef: 0.6, costExp: 3, offset: 0, effect: 'Mana Capacity', pref: '+', app: 'm'},
    {tier: 'D', id: 48, name: 'Great Fay Medallion', maxLvl: 0, addupPerLvl: 0.1, damPerLvl: 0.4, costCoef: 0.7, costExp: 2.0, offset: 1, effect: 'Fairy Gold', pref: '&#10005', app: ''},
    // E
    ...
    {tier: 'E', id: 29, name: 'Oak Staff', maxLvl: 30, addupPerLvl: 1, damPerLvl: 0.8, costCoef: 0.6, costExp: 3, offset: 0, effect: 'Fire Sword Cost', pref: '-', app: 'm'},
    ...
    {tier: 'E', id: 31, name: 'Glove of Kuma', maxLvl: 30, addupPerLvl: 1, damPerLvl: 0.8, costCoef: 0.6, costExp: 3, offset: 0, effect: 'Critical Strike Cost', pref: '-', app: 'm'},
    ...
    {tier: 'E', id: 33, name: 'Hunter\'s Ointment', maxLvl: 40, addupPerLvl: 1, damPerLvl: 0.8, costCoef: 0.6, costExp: 3, offset: 0, effect: 'Shadow Clone Cost', pref: '-', app: 'm'},
    ...
    {tier: 'E', id: 35, name: 'Infinity Pendulum', maxLvl: 20, addupPerLvl: 1, damPerLvl: 0.9, costCoef: 0.6, costExp: 3, offset: 0, effect: 'Heavenly Strike Cost', pref: '-', app: 'm'},
    ...
    // new artifacts done
    {tier: 'E', id: 46, name: 'Zakinthos Coin', maxLvl: 0, addupPerLvl: 0.2, damPerLvl: 0.3, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Inactive Gold', pref: '&#10005', app: ''},
    {tier: 'E', id: 47, name: 'The Master\'s Sword', maxLvl: 40, addupPerLvl: 2, damPerLvl: 2, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Sword Master Upgrade Cost', pref: '-', app: '%'},
    {tier: 'E', id: 45, name: 'Avian Feather', maxLvl: 0, addupPerLvl: 0.2, damPerLvl: 0.3, costCoef: 0.6, costExp: 1.7, offset: 1, effect: 'Inactive Damage', pref: '&#10005', app: ''},
    // new artifacts remaining
    {tier: 'E', id: 44, name: 'Samosek Sword', maxLvl: 0, addupPerLvl: 0.1, damPerLvl: 0.5, costCoef: 0.6, costExp: 2.0, offset: 1, effect: 'Sword  Attack Damage', pref: '&#10005', app: ''}
];