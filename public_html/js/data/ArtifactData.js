...
TT2.Artifacts = [
    ...
    // A
    {tier: 'A', id: 2, name: 'Parchment of Foresight', maxLvl: 0, build: 'CS,SC', addupPerLvl: 0.1, damPerLvl: 0.4, costCoef: 0.6, costExp: 1.7, offset: 1, effect: 'War Cry Skill Effect', pref: '&#10005', app: '',
    ...
    {tier: 'A', id: 3, name: 'Laborer\'s Pendant', maxLvl: 0, build: '', addupPerLvl: 0.1, damPerLvl: 0.4, costCoef: 0.6, costExp: 1.7, offset: 1, effect: 'Hand Of Midas Effect', pref: '&#10005', app: '',
        growthMax: 0.05, growthRate: '5E-05', growthExpo: 1},
    {tier: 'A', id: 43, name: 'Invader\'s Gjalarhorn', maxLvl: 0, build: 'CS,SC', addupPerLvl: 0.02, damPerLvl: 0.2, costCoef: 0.6, costExp: 1.8, offset: 1, effect: 'All Active Skill Effect', pref: '&#10005', app: '',
    ...
    {tier: 'A', id: 4, name: 'Heroic Shield', maxLvl: 0, build: '', addupPerLvl: 0.2, damPerLvl: 0.5, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Boss Gold', pref: '&#10005', app: '',
        growthMax: 0.05, growthRate: '5E-05', growthExpo: 1},
    {tier: 'A', id: 5, name: 'Furies Bow', maxLvl: 0, build: 'CS,SC', addupPerLvl: 0.15, damPerLvl: 0.6, costCoef: 0.7, costExp: 1.7, offset: 1, effect: 'Ranged Hero Damage', pref: '&#10005', app: '',
        growthMax: 0.05, growthRate: '5E-05', growthExpo: 1},
    {tier: 'A', id: 9, name: 'Hero\'s Blade', maxLvl: 0, build: 'CS,SC', addupPerLvl: 0.1, damPerLvl: 0.5, costCoef: 0.7, costExp: 1.7, offset: 1, effect: 'All Hero Damage', pref: '&#10005', app: '',
        growthMax: 0.05, growthRate: '5E-05', growthExpo: 1},
    // B
    ...
    {tier: 'B', id: 11, name: 'Divine Retribution', maxLvl: 0, build: '', addupPerLvl: 0.1, damPerLvl: 0.3, costCoef: '1.0', costExp: 2, offset: 1, effect: 'All Damage', pref: '&#10005', app: '',
        growthMax: 0.04, growthRate: '3.75E-05', growthExpo: 1},
    {tier: 'B', id: 17, name: 'Royal Toxin', maxLvl: 0, build: 'CS,SC', addupPerLvl: 0.1, damPerLvl: 0.5, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Deadly Strike Effect', pref: '&#10005', app: '',
        growthMax: 0.05, growthRate: '5E-05', growthExpo: 1},
    ...
    {tier: 'C', id: 6, name: 'Fruit of Eden', maxLvl: 0, build: 'PET', addupPerLvl: 0.1, damPerLvl: 0.3, costCoef: 0.7, costExp: 2, offset: 1, effect: 'Pet Damage', pref: '&#10005', app: '',
        growthMax: 0.045, growthRate: '4.5E-05', growthExpo: 1},
    {tier: 'C', id: 37, name: 'Drunken Hammer', maxLvl: 0, build: 'SC', addupPerLvl: 0.1, damPerLvl: 0.3, costCoef: 0.6, costExp: 1.7, offset: 1, effect: 'Tap Damage', pref: '&#10005', app: '',
        growthMax: 0.05, growthRate: '5E-05', growthExpo: 1},
    {tier: 'C', id: 44, name: 'Samosek Sword', maxLvl: 0, build: 'SC', addupPerLvl: 0.1, damPerLvl: 0.5, costCoef: 0.7, costExp: 2.0, offset: 1, effect: 'Sword  Attack Damage', pref: '&#10005', app: '',
    ...
    {tier: 'C', id: 34, name: 'Elixir of Eden', maxLvl: 0, build: 'SC', addupPerLvl: 0.1, damPerLvl: 0.4, costCoef: 0.6, costExp: 1.7, offset: 1, effect: 'Shadow Clone Effect', pref: '&#10005', app: '',
        growthMax: 0.05, growthRate: '5E-05', growthExpo: 1},
    {tier: 'C', id: 27, name: 'Bringer of Ragnarok', maxLvl: 0, build: 'SC', addupPerLvl: 0.1, damPerLvl: 0.4, costCoef: 0.6, costExp: 1.7, offset: 1, effect: 'Fire Sword Effect', pref: '&#10005', app: '',
        growthMax: 0.05, growthRate: '5E-05', growthExpo: 1},
