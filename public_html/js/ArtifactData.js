...
TT2.Artifacts = [
    ...
    // new artifacts
//    {tier: 'E', id: 41, name: 'X1', maxLvl: 0, addupPerLvl: 2, damPerLvl: 0.8, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Mana Capacity', pref: '+', app: ''},
//    {tier: 'E', id: 42, name: 'X2', maxLvl: 30, addupPerLvl: 1, damPerLvl: 0.8, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'All Active Skill Duration', pref: '+', app: 's'},
//    {tier: 'E', id: 43, name: 'X3', maxLvl: 0, addupPerLvl: 0.02, damPerLvl: 0.2, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'All Active Skill Effect', pref: '&#10005', app: ''},
//    {tier: 'E', id: 44, name: 'X4', maxLvl: 0, addupPerLvl: 0.1, damPerLvl: 0.5, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Swort Attack Damage', pref: '&#10005', app: ''},
//    {tier: 'E', id: 45, name: 'X5', maxLvl: 0, addupPerLvl: 0.2, damPerLvl: 0.3, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Inactive Damage', pref: '&#10005', app: ''},
//    {tier: 'E', id: 46, name: 'X6', maxLvl: 0, addupPerLvl: 0.2, damPerLvl: 0.3, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Inactive Gold', pref: '&#10005', app: ''},
//    {tier: 'E', id: 47, name: 'X7', maxLvl: 0, addupPerLvl: 2, damPerLvl: 2, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Sword Master Upgrade Cost', pref: '-', app: '%'},
//    {tier: 'E', id: 48, name: 'X8', maxLvl: 0, addupPerLvl: 0.1, damPerLvl: 0.4, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Fairy Gold', pref: '&#10005', app: ''},
//    {tier: 'E', id: 49, name: 'X9', maxLvl: 0, addupPerLvl: 0.025, damPerLvl: 0.3, costCoef: 0.7, costExp: 1.8, offset: 1, effect: 'Splash Damage', pref: '+', app: '%'}
];